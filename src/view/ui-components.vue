                    ...
                    <div class="panel-content">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <m-label type="default">Gray</m-label>
                                <m-label type="primary">Blue</m-label>
                                <m-label type="success">Green</m-label>
                                <m-label type="info">Light blue</m-label>
                                <m-label type="warning">Orange</m-label>
                                <m-label type="danger">Red</m-label>
                                <h3><strong>Badges</strong> colors</h3>
                                <p>Just like labels, add the the class <code>.badge</code> to create one.</p>
                                <button class="btn btn-primary" type="button">
                                    Messages&nbsp;&nbsp;<span class="badge">4</span>
                                </button>
                                <m-button type="primary"> Messages&nbsp;&nbsp;<m-label badge="badge">4</m-label></m-button>
                                <m-label badge="primary">4</m-label>
                                <m-label badge="success">3</m-label>
                                <m-label badge="info">2</m-label>
                                <m-label badge="warning">4</m-label>
                                <m-label badge="danger">9</m-label>
                            </div>
                            <div class="col-md-6">
...
<script>
    import MLabel from '../components/label/Label'
    import MButton from '../components/button/Button'

    export default {
        name: "ui-components",
        components:{MLabel,MButton}
    }
</script>
